...
$(document).ready(function() {
    ...
    if ($("#rev_slider_151_1").revolution == undefined) {
        ...
        $("#rev_slider_151_1").show().revolution({
            sliderType: "standard",
            jsFileLocation: "site/revolution/js/",
...
/* ===================================
 ...
 ====================================== */
    ...
    $('#ModalEscolha').on('show.bs.modal', function(event) {
        ...
        modal.find('.modal-body .container-politica p').html(data)
...
/* ===================================
   New Navar effect color
 ====================================== */

 $(window).scroll(function() {
    if ($(document).scrollTop() > 50) {
        $('.nav-top-main' ).addClass('affix');
    } else {
        $('.nav-top-main').removeClass('affix');
    }
});

$('.nav-top-main .navTringger').click(function () {
    $(this).toggleClass('active');
...
$('#mainlistDiv a').click(function (){
    ...
    $('.nav-top-main .navTringger').toggleClass('active');
})


/* ===================================
  Finish New Navar effect color
 ====================================== */


$(window).load(function(){
   setTimeout($('.preload').fadeToggle(), 2500)
