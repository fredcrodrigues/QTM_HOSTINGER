            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ URL::to('area-restrita/servicos') }}">Serviço</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br><br>
                        <form method="POST" action="{{ URL::to('area-restrita/servico-oferecido') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
