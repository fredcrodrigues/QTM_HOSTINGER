            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ URL::to('area-restrita/depoimentos') }}">Depoimento</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br><br>
                        <form method="POST" action="{{ URL::to('area-restrita/depoimentos') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" accept="image/*" onchange="loadFile(event)" class="form-control @error('imagem_depoimento') is-invalid @enderror"
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea class="textarea form-control @error('texto') is-invalid @enderror"
                                        ...
                                        style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('texto') }}</textarea>
                                    @error('texto')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
