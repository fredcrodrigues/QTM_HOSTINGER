@extends('Admin.layouts.partials_admin.app')
 ...
 @section('contentheader_title', 'Conselho')
        ...
        <div class="col-12">
          <div class="card">
               ...
               @include('Admin.layouts.partials_admin.alert')
                  ...
                  <br><br>
                <form method="POST" action="/area-restrita/conselho" id="conselho">
                      @csrf
                          <div class="form-row">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                    <table id="table_conselho" class="table table-bordered table-hover" width="100%">
                        <thead>
                          <tr>
                            <th>Título</th>
                            <th>Status</th>
...
@section('scripts_adicionais') 
   ...
   <script src="{{ asset('js/admin/listar_conselho.js') }}"></script>
@endsection
