        ...
        <div class="col-12">
           ...
           <div class="card-header">
                <div class="col-md-3 float-right">
                  <a href="{{ URL::to('area-restrita/noticias') }}" class="btn btn-block btn-outline-info "><i class="fa fa-list-alt"></i> Listar Notícias</a>
                </div>
              </div>
                <div class="card-body">
                @include('Admin.layouts.partials_admin.alert')
              <form  method="POST" id="form" action="/area-restrita/noticias" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                      ...
                      <br><br>
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name='titulo' value="{{ old('titulo') }}" class="form-control @error('titulo') is-invalid @enderror" placeholder="título da notícia">
                                @error('titulo')
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="date" id = 'data' name='data' class="form-control @error('data') is-invalid @enderror" placeholder="Data da notícia">
                                @error('data')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <!-- <div class="needsclick  dropzone @error('imagem_noticia') is-invalid @enderror" id="imagem_noticia"></div> -->
