...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Alterar Membro do Time QTM</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ URL::to('area-restrita/time-qtm') }}">Time QTM</a></li>
                        <li class="breadcrumb-item active">Alterar Membro do Time QTM</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br><br>
                        <form method="POST" action="/area-restrita/time-qtm/{{$time->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name='cargo' value="{{$time->cargo}}"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    name='imagem_time'>
                                    <br>
                                    <img id="output" width="300" src="{{$time->getFirstMediaUrl('time-imagem')}}"/>
                                    @error('imagem_time')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea class="ckeditor form-control @error('conteudo') is-invalid @enderror"
                                        name='conteudo' id='conteudo'>{{$time->conteudo}}</textarea>
                                    @error('conteudo')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
