          ...
          <div class="card">
                <div class="card-header">
                  <div class="float-right">
                          <a href="{{ URL::to('area-restrita/especialidade') }}" class="btn btn-block btn-outline-info "><i class="fa fa-list-alt"></i> Listar Especialidades</a>
                      </div>
                  </div>
                 <!-- /.card-header -->
               <div class="card-body">
                 @include('Admin.layouts.partials_admin.alert')
                  ...
                  <br><br>
                <form method="POST" action="/area-restrita/especialidade/{{$modelo->id}}" id="especialidade">
                      @csrf
                      @method('PUT')
                          <div class="form-row">
