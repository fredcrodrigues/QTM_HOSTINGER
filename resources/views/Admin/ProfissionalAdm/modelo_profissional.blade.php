        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="form-group col-sm-6">
                    <h1>Alterar Modelo Agendamento do Profissional</h1>
                </div>
    ...
    <section class="content">
        <div class="row">
            <div class="form-group col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="/area-restrita/profissional-adm/agendamento">
                        @csrf
...
<script src="{{ asset('js/admin/modelo_profissional.js') }}"></script>
@endsection