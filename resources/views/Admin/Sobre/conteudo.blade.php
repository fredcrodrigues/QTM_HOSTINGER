...
@section('title', 'Conteúdo Sobre Nós')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Editar Conteúdo Sobre Nós</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">Sobre Nós</li>
                        <li class="breadcrumb-item active">Editar Conteúdo Sobre Nós</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br><br>
                        <form method="POST" action="/area-restrita/sobre-nos-conteudo/{{$sobre_nos->id}}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name='conteudo' class="ckeditor form-control @error('conteudo') is-invalid @enderror">{{$sobre_nos->conteudo}}</textarea>
                                    @error('conteudo')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
