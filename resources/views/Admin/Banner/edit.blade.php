            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Alterar Banner</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br><br>
                        <form method="POST" action="/area-restrita/banner/{{$banner->id}}"enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    name='imagem_banner'>
                                    <br>
                                    <img id="output" width="300" src="{{$banner->getFirstMediaUrl('banner-imagem')}}"/>
                                    @error('imagem_banner')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
