...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Adicionar Serviço da QTM</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ URL::to('area-restrita/servicos') }}">Serviço da QTM</a></li>
                        <li class="breadcrumb-item active">Adicionar Serviço da QTM</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="col-2 float-right">
                            <a href="{{ URL::to('area-restrita/servicos/') }}"
                    ...
                    <div class="card-body">
                        ...
                        <br><br>
                        <form method="POST" action="{{ URL::to('area-restrita/servicos') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
