            ...
            <div class="form-group col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br><br>
                        <form method="POST" action="/area-restrita/colaborador/{{$colaborador->id}}/update-senha"enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                            <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="nome" id="nome" value="{{ $colaborador->nome }}"
                                        class="form-control @error('nome') is-invalid @enderror" readonly>
                                    @error('nome')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="email" id="email" placeholder="example@email.com"
                                        ...
                                        value="{{ $colaborador->email }}" readonly>
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="password" name="senha" id="senha" placeholder="Digite aqui a nova senha"
